...
(doom! :input
  ...
  (org +present +pretty +roam +journal +jupyter) ; organize your plain life in plain text
  ...
  ;;rst               ; ReST in peace
  (ruby +lsp +tree-sitter +rbenv +rails) ; 1.step {|i| p "Ruby is #{i.even? ? 'love' : 'life'}"}
