...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    RESET, KC_LCTL, KC_LALT, KC_LGUI, MO(1), KC_ENT, KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT
  ),
	[1] = LAYOUT_ortho_5x12(
    ...
    RESET, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MPLY, KC_VOLD, KC_VOLU, KC_MNXT
  ),
	[2] = LAYOUT_ortho_5x12(
